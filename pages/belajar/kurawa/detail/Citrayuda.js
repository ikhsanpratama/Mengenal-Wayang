              ...
              <View style={{ backgroundColor:'transparent', height:'80%', flexDirection:'column', flex:1}}>
                  <View style={{backgroundColor:'transparent', height:'80%', width:'100%', flex:1, flexDirection:'row'}}>
                      <View style={{width:'40%', backgroundColor:'transparent'}}>
                        <Image source={require('../../../../../android/app/src/main/res/raw/citrayuda_1.png')} style={{width:155,height:'100%', right:-130}}></Image>
                      </View>
                      <View style={{width:'60%', alignItems:'center', backgroundColor:'transparent'}}>
                        ...
                        <Text style={styles.text}>Aku adalah Citrayuda salah satu dari 100 Kurawa, anak dari ayahku prabu Destarata dan ibu Ghandari. Diantara saudaraku aku paling berani. tidak hanya itu, aku juga yang paling kuat dan paling hebat diantara Kurawa yang lain. Dengan begitu setiap latihan perang akulah yang  menjadi pemimpinnya.</Text>
                        <Pressable
                              style={styles.tombol}
                              onPress={audio_play}
