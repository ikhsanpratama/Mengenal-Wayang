              ...
              <View style={{ backgroundColor:'transparent', height:'80%', flexDirection:'column', flex:1}}>
                  <View style={{backgroundColor:'transparent', height:'80%', width:'100%', flex:1, flexDirection:'row'}}>
                      <View style={{width:'40%', backgroundColor:'transparent'}}>
                        <Image source={require('../../../../../android/app/src/main/res/raw/dursasana_1.png')} style={{width:175,height:'100%', right:-130}}></Image>
                      </View>
                      <View style={{width:'60%', alignItems:'center', backgroundColor:'transparent'}}>
                        ...
                        <Text style={styles.text}>Aku Dursanana adalah adik dari Duryudana, tentu saja aku merupakan anak dari Prabu Destarata dan Ibu Dewi Ghandari. Aku selalu membantu kakakku untuk melawan Pandawa. Aku sangat mendukung ambisi kakakku yang ingin menjadi raja di Astinapura. Boleh dikatakan aku merupakan tangan kanan kakakku Duryudana.</Text>
                        <Pressable
                              style={styles.tombol}
                              onPress={audio_play}
